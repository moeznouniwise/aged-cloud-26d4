...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/aged-cloud-26d4
```

A live public deployment of this template is available at [https://aged-cloud-26d4.templates.workers.dev](https://aged-cloud-26d4.templates.workers.dev)
